...
task.registerHelper('mockup-templates', function(name, data) {
  ...
  files.forEach(function(file) {
    ...
    //
    // Partials are supported. To include a partial, use underscores
    // instead of slashed in your path, and leave off the extension.
...
// task.registerHelper('error', config.bind(config, 'errors'));
